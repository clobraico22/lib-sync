    ...
    if token:
        ...
        for playlist in rekordbox_playlists:
            ...
            tracks_uris_to_add = [
                ...
                if rekordbox_to_spotify_map[track_id]
            ]
            spotify_client.user_playlist_add_tracks(
                user=spotify_username,
                playlist_id=spotify_playlist_data["uri"],
                tracks=tracks_uris_to_add,
            )
        ...
        if create_collection_playlist:
            ...
            logging.info("created spotify playlist: Collection")
            ...
            logging.info("added tracks to spotify playlist: Collection")
